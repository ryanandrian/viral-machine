...
|---|---|---|---|---|
| M1 | Lapis 1 kolektor + fitur turunan + backfill RAD | ±1 sesi | Ketok K1 | Kurva ≥80% video RAD eligible · fitur turunan identik vs hitung manual · nol error API beruntun |
| M2 | Vonis loop (dua-sinyal) + konsistensi tampilan | ±½ sesi | Vonis K2 | Nilai konsisten di semua permukaan |
