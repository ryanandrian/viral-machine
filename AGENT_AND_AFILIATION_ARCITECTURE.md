...
## §10 CHANGELOG
- **2026-07-20** — Ketok owner 4 item (keluhan "panduan agen tidak jelas, panduan reseller belum ada" + pertanyaan Google reseller): (1) revisi panduan agen (Google login · atribusi per-reseller eksplisit · FAQ MGM) · (2) **panduan RESELLER baru** + tombol Panduan di shell reseller · (3) **Google login /reseller/login** (cermin agen) · (4) §9d → TIGA panduan. Jawaban terdokumentasi: atribusi reseller = kode unik reseller saat tenant daftar (dua-arah, permanen).
