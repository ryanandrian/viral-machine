...
1. **POSISI TERKINI:** ✅ **F1 + F2 LIVE DI PRODUKSI** (F2 deployed 2026-07-17 11:25 izin owner "deploy FE batch F2", commit `b8a3121`, situs 200; verifikasi produksi: /agent/login 200 + badge PARTNER di HTML ✓ · /agent anon→login 307 ✓ · route invite anon 401 ✓). Sisa bukti-mata owner: buat agen uji → Undang login portal → set sandi → dasbor. **Rencana F3 reseller SUDAH diajukan (lihat §7-F3) — menunggu ketok owner.**
