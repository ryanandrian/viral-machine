    ...
    <>
      ...
      <section className="mk-section-sm"><div className="mk-container">
        <div className="stats reveal">
          ...
          <div className="stat"><div className="big">±10×</div><div className="lbl"><Bi id="Lebih murah" en="Cheaper" /></div><div className="desc"><Bi id="±Rp 1.736/video all-in (Business + AI premium) vs Rp 18.000 di AutoShorts — lihat ilustrasi biaya di halaman pricing" en="±Rp 1,736/video all-in (Business + premium AI) vs Rp 18,000 on AutoShorts — see the cost illustration on the pricing page" /></div></div>
      ...
      <section className="mk-section" style={{ background: "var(--bg-elevated)", borderBlock: "1px solid var(--border-subtle)" }}><div className="mk-container">
        ...
        <div className="mk-center muted" style={{ fontSize: "var(--text-xs)", marginTop: ".6rem" }}><Bi id="*Ilustrasi paket Business + racikan AI premium dari produksi nyata (lihat ilustrasi biaya di halaman pricing); dengan racikan gratis bisa mendekati ±Rp 466/video." en="*Illustration: Business plan + premium AI mix from real production (see the cost illustration on the pricing page); with a free mix it can approach ±Rp 466/video." /></div>
      </div></section>
      ...
      <section className="mk-section" id="pricing"><div className="mk-container">
        ...
        {/* Ilustrasi biaya per video DIPINDAH ke /pricing seksi BYOK (keputusan owner 2026-07-14). */}
      </div></section>
