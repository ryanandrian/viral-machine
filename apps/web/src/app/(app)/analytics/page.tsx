...
export default function AnalyticsPage() {
  ...
  if (!ov || ov.videos === 0) return (
    <>
      <PageHeader helpKey="analytics" icon={BarChart3} title="Analytics" subtitle={<Bi id="Performa channel dari data nyata" en="Real channel performance" />} />
  ...
  return (
    <>
      <PageHeader helpKey="analytics" icon={BarChart3} title="Analytics"
