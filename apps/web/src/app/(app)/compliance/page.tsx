...
export default function CompliancePage() {
  ...
  return (
    <>
      <PageHeader helpKey="compliance" icon={ShieldCheck} title="Compliance Score" subtitle={<Bi id="AI Slop Defense · rata-rata semua channel" en="AI Slop Defense · averaged across all channels" />} />
