...
// Di bawah gate /agent/* middleware (role agent) — tanpa sesi/peran benar tak pernah sampai sini.
  ...
  return (
    <div style={{ minHeight: "100dvh", display: "grid", placeItems: "center", padding: "1.5rem", background: "var(--bg)" }}>
      <div className="auth-card" style={{ width: "min(400px, 100%)" }}>
        ...
        <p className="lead" style={{ marginBottom: "1rem" }}><Bi id="Sekali ini saja — setelah ini masuk lewat /agent/login." en="One time only — afterwards sign in at /agent/login." /></p>
