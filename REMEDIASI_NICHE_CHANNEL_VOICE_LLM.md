...
- **⚠️ CATATAN (butuh konfirmasi owner, BUKAN task):** approve item `/review` TIDAK melepas `channels.production_paused` (circuit-breaker) — hanya direct-produce sukses yang auto-lepas. Owner 2026-06-20: jangan ubah skema ini tanpa konfirmasi; bila skema sekarang dianggap benar → biarkan. (Dicatat agar tak hilang; tindakan hanya bila owner minta.)
