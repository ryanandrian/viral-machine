...
| G5 | ~~**invalid_grant senyap**: tak ada penandaan `status='invalid'`/nonaktif/notif saat refresh-token mati.~~ ✅ **DIBERESKAN 2026-07-18 (=3.2, kode; belum deploy)** — lihat tabel Batch 3. | Melanggar "no silent degradation"; berlaku juga single-channel. |
