...
| Toleransi panjang naskah (0.12) | **ENV** `SCRIPT_LENGTH_TOLERANCE` — ⚠️ **CONFIG MATI** (didefinisikan `script_engine.py:1043` tapi TIDAK pernah dibaca gerbang; gerbang `length_ok` hardcode 0.90/1.10) → dihidupkan/disatukan di F3 | `script_engine.py` |
