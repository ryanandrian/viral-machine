...
- **BELUM DIKERJAKAN & BUKAN BAGIAN ITEM INI:** sebab **mesin mati mendadak** (11× tercatat sejak 3-Jul; 10× dalam 18 hari sejak 27-Jul). Catatan inti sistem menunjuk **ke dalam mesin bahasa Python sendiri**, bukan ke pustaka gambar/font — dugaan Pillow/fonttools **DICABUT** (hanya 4 dari 10 kematian punya jejak render). Kehabisan memori **disingkirkan** (2,9 GB bebas, nol catatan OOM). Langkah D ("buat mesin bersuara saat mati") **belum diketok owner**.
