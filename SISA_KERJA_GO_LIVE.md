...
---
### Changelog
- **2026-08-23 (2) — 🧭 RENCANA F1–F8 rantai harga & biaya DITETAPKAN, progresnya dilacak di SSOT.** Sesudah riset sehari penuh (10 cacat, semuanya karya saya sendiri; 4 kebenaran ditetapkan; APIMaster & OpenRouter diuji dengan perintah produksi nyata). **PENUNJUK TUNGGAL: `ARSITEKTUR_AI_PROVIDER_MODEL.md` §7f** — di situ rencana, status tiap langkah, 14 formula, aturan mengikat, dan angka acuan. Jangan menyentuh rantai harga/biaya tanpa membaca §7f lebih dulu. ✅ **F1–F4 SELESAI 23-Agu** (migr `0210` 47/47 ber-formula · penghitung memakai formula, 246 run → **246 identik** · migr `0211` URL sumber harga jadi kenop admin + **pagar agregator**) · migr `0212`/`0213` API harga resmi penyedia → **7 dari 12 model fal otomatis** (3 naskah fal kini **$0,001/permintaan** = tarif fal yang benar) · ⬜ F4b (flux/seedance) · F5–F8. ⚠️ suara Gemini masih $2,5 (resmi $10) — **F7**.
