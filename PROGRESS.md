...
- [ ] **D4/F3b — Skor dimensi dari angka nyata** *(propose-first, lebih besar):* isi `_calculate_viral_score` (`competition_gap`/`momentum`) dari velocity/views YouTube + momentum Trends; LLM hanya meramu angle. Refactor scoring inti — kerjakan saat owner approve.
