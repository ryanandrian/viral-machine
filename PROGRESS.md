...
| **5** | Multi-Channel + Decouple | `channels`, channel_id, content_inventory, S3 buffer, producer/publisher | 1 minggu | 🛠️ in-progress — **5.1 foundation ✅** (content_inventory + channel_id + s3_buffer util, 0011). **5.3 decouple = design-review** (`PHASE5_DESIGN.md`). |
