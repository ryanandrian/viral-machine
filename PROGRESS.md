...
- **➡️ BERIKUTNYA (urutan diputuskan expert, jalur go-live) = PHASE 6.4** insights per-tag + filter-channel → **Phase 7** Compliance Score (calc feed widget D20) → **8** payment(Midtrans)+tier-gating → **9-10** FE wiring/sinkronisasi (long pole) → **11** beta. *(follow-up 6.2: voice rotation saat voice-catalog/ElevenLabs.)*
